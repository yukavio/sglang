...
def convert_blockmask(blockmask, causal):
    ...
    last_nonzero_col_per_row = blockmask.sort(
        dim=-1, stable=True).indices[:, -1]
    ...
    first_nonzero_col_per_row = blockmask.sort(
        dim=-1, stable=True, descending=True).indices[:, 0]
    ...
    nonzero_idx[last_nonzero_col_per_row_after_sort,
                last_nonzero_col_per_row] += 2
    nonzero_idx[first_nonzero_col_per_row_after_sort,
                first_nonzero_col_per_row] += 1
